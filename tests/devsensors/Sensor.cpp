...
LightSensor::LightSensor(int32_t sensorHandle, ISensorsEventCallback* callback)
  : OnChangeSensor(sensorHandle, callback) {
    mSensorInfo.name = "Meteoria Light Sensor";
...
TemperatureSensor::TemperatureSensor(int32_t sensorHandle, ISensorsEventCallback* callback)
  : OnChangeSensor(sensorHandle, callback) {
    mSensorInfo.name = "Meteoria Temperature Sensor";
    mSensorInfo.vendor = "devtitans";
...
HumiditySensor::HumiditySensor(int32_t sensorHandle, ISensorsEventCallback* callback)
  : OnChangeSensor(sensorHandle, callback) {
    mSensorInfo.name = "Meteoria Humidity Sensor";
    mSensorInfo.vendor = "devtitans";
...
PressureSensor::PressureSensor(int32_t sensorHandle, ISensorsEventCallback* callback)
  : OnChangeSensor(sensorHandle, callback) {
    mSensorInfo.name = "Meteoria Pressure Sensor";
    mSensorInfo.vendor = "devtitans";
...
RainSensor::RainSensor(int32_t sensorHandle, ISensorsEventCallback* callback)
  : OnChangeSensor(sensorHandle, callback) {
    mSensorInfo.name = "Meteoria Rain Sensor";
    mSensorInfo.vendor = "devtitans";
...
GroundSensor::GroundSensor(int32_t sensorHandle, ISensorsEventCallback* callback)
  : OnChangeSensor(sensorHandle, callback) {
    mSensorInfo.name = "Meteoria Ground Sensor";
    mSensorInfo.vendor = "devtitans";
    mSensorInfo.type = SensorType::RELATIVE_HUMIDITY;
    mSensorInfo.typeAsString = SENSOR_STRING_TYPE_RELATIVE_HUMIDITY;
    mSensorInfo.maxRange = 43000.0f;
...
std::vector<Event> LightSensor::readEvents() {
    int in = weatherstation.getLuminosity();
    std::vector<Event> events;
    Event event_s;
...
std::vector<Event> TemperatureSensor::readEvents() {
    int in = weatherstation.getTemperature();
    std::vector<Event> events;
    Event event_s;
    event_s.timestamp = ::android::elapsedRealtimeNano();
    event_s.sensorHandle = mSensorInfo.sensorHandle;
...
std::vector<Event> HumiditySensor::readEvents() {
    int in = weatherstation.getHumidity();
    std::vector<Event> events;
    Event event_s;
    event_s.timestamp = ::android::elapsedRealtimeNano();
    event_s.sensorHandle = mSensorInfo.sensorHandle;
...
std::vector<Event> PressureSensor::readEvents() {
    int in = weatherstation.getPressure();
    std::vector<Event> events;
    Event event_s;
    event_s.timestamp = ::android::elapsedRealtimeNano();
    event_s.sensorHandle = mSensorInfo.sensorHandle;
...
std::vector<Event> RainSensor::readEvents() {
    int in = weatherstation.getRain();
    std::vector<Event> events;
    Event event_s;
    event_s.timestamp = ::android::elapsedRealtimeNano();
    event_s.sensorHandle = mSensorInfo.sensorHandle;
...
std::vector<Event> GroundSensor::readEvents() {
    int in = weatherstation.getGround();
    std::vector<Event> events;
    Event event_s;
    event_s.timestamp = ::android::elapsedRealtimeNano();
    event_s.sensorHandle = mSensorInfo.sensorHandle;
