...
class TemperatureSensor : public OnChangeSensor {
    public:
...
class HumiditySensor : public OnChangeSensor {
    public:
        HumiditySensor(int32_t sensorHandle, ISensorsEventCallback* callback);
...
class PressureSensor : public OnChangeSensor {
    public:
...
class RainSensor : public OnChangeSensor {
    public:
        RainSensor(int32_t sensorHandle, ISensorsEventCallback* callback);
...
class GroundSensor : public OnChangeSensor {
    public:
        GroundSensor(int32_t sensorHandle, ISensorsEventCallback* callback);
